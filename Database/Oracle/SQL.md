...
51. [다중조인](#51-다중조인)<BR/>
52. [다중행에 대한 대소비교하기](#52-다중행에-대한-대소비교하기)<BR/>
53. [다중열 서브쿼리](#53-다중열-서브쿼리)<BR/>
54. [다중행 다중열 서브쿼리](#54-다중행-다중열-서브쿼리)<BR/>\
55. [INLINE VIEW](#55-INLINE-VIEW)<BR/>
56. [일련번호 ROWNUM](#56-ROWNUM)<BR/>
57. [중복값 무시 RANK_OVER()](#57-RANK_OVER())<BR/>
58. [중복값 포함 DENSC_RANK()](#58-DENSC_RANK())<BR/>
...
```
# 52. 서브쿼리
- SELECT 문 안에 SELECT문이 하나 더 있는 쿼리문을 말한다.
...
```
- 이런식으로 괄호안에 쿼리문을 하나더 사용해서 조건을 만들수가있다.

<BR/>

## 단일행 서브쿼리
- 서브쿼리 SELECT문의 결과가  1개열, 1개행인 것
- 컬럼(SELECT), WHERE절에 비교대상 값 에 사용한다.
...
-------------------------------------------------------------
선동일	8000000	D9	3047662.60869565217391304347826086956522
송종기	6000000	D9	3047662.60869565217391304347826086956522
노옹철	3700000	D9	3047662.60869565217391304347826086956522
유재식	3400000	D6	3047662.60869565217391304347826086956522
정중하	3900000	D6	3047662.60869565217391304347826086956522
심봉선	3500000	D5	3047662.60869565217391304347826086956522
대북혼	3760000	D5	3047662.60869565217391304347826086956522
전지연	3660000	D1	3047662.60869565217391304347826086956522
...
----------------------------------------------------------------------------
209	심봉선	750206-1325546	sim_bs@BS.or.kr	0113654485	D5	J3
204	유재식	660508-1342154	yoo_js@BS.or.kr	01099999129	D6	J3
205	정중하	770102-1357951	jung_jh@BS.or.kr 01036654875	D6	J3
215	대북혼	881130-1050911	dae_bh@BS.or.kr	01088808584	D5	J5
207	하이유	690402-2040612	ha_iy@BS.or.kr	01036654488	D5	J5
208	김해술	870927-1313564	kim_hs@BS.or.kr	01078634444	D5	J5
```
<BR/>
...
----------------------------------------------------------------------------------
200	선동일	621235-1985634	sun_di@BS.or.kr	01099546325	D9	J1
201	송종기	631156-1548654	song_jk@BS.or.kr 01045686656	D9	J2
205	정중하	770102-1357951	jung_jh@BS.or.kr 01036654875	D6	J3
215	대북혼	881130-1050911	dae_bh@BS.or.kr	01088808584	D5	J5
202	노옹철	861015-1356452	no_hc@BS.or.kr	01066656263	D9	J2
217	전지연	770808-2665412	jun_jy@BS.or.kr	01033624442	D1	J6
209	심봉선	750206-1325546	sim_bs@BS.or.kr	0113654485	D5	J3
204	유재식	660508-1342154	yoo_js@BS.or.kr	01099999129	D6	J3
218	이오리	870427-2232123	loo_or@BS.or.kr	01022306545	NULL	J7
```
...
WHERE (DEPT_CODE, JOB_CODE) IN (SELECT DEPT_CODE, JOB_CODE FROM EMPLOYEE WHERE ENT_YN = 'Y' AND SUBSTR(EMP_NO, 8, 1) = '2')
            AND ENT_YN = 'N';
--------------------------------------------------------------------------------------------
211	전형돈	830807-1121321	jun_hd@BS.or.kr	01044432222	D8	J6	S5	2000000	NULL	200	12/12/12	N
212	장쯔위	780923-2234542	jang_zw@BS.or.kr 01066682224	D8	J6	S5	2550000	0.25	211	15/06/17	N
```
<BR/>
...
---------------------------------------------------------------------
201	송종기	631156-1548654	song_jk@BS.or.kr 01045686656	D9	J2	S1	6000000	NULL	200	01/09/01	N
200	선동일	621235-1985634	sun_di@BS.or.kr	01099546325	D9	J1	S1	8000000	0.3	NULL	90/02/06	N
202	노옹철	861015-1356452	no_hc@BS.or.kr	01066656263	D9	J2	S4	3700000	NULL	201	01/01/01	N
```
<BR/>
...
전형돈	D8	3
```
- 별칭을 정해서 자신이 속한 DEPT_CODE를 카운트한다.
...
------------------------------------------------------------------------------------
214	방명수	856795-1313513	bang_ms@BS.or.kr	01074127545	D1	J7	S6	1380000		200	10/04/04		N
```
- EXISTS는 ROW수로 계산하기떄문에 SALARY대신 아무거나써도된다.
- SALARY가 FALSE가되는걸찾아라 
- SALARY 로나온애가 E.SALARY에서 가져온애보다 작은게없다라는건  FALSE라는것이다
- 그걸  NOT EXISTS로 적엇으니 TRUE 가나와서 출력된다.
	- 쉽게 설명하자면
	- E.SALARY가 800이고 SALARY가 300 이면 
	- 그사이에잇는것들은 TRUE이기때문에 행이나온다.
	- 하지만 NOT 을사용햇기때문에 FALSE다.  그럼해당이되지않는다
	- 하지만 E.SALARY도 200 SALARY도 200 둘다최소값이면 FALSE가나온다
	- NOT을썻기때문에 FALSE는 TRUE 가된다.
	- 그렇게 최소값을 구할수가 있다.
...
# 55. INLINE VIEW
- FROM 절에 서브쿼리 이용하기
- FROM절에 사용하는 서브쿼리는 대부분 다중행 다중열서브쿼리 사용한다
- RESULT SET을 하나의 테이블처럼 사용하게 하는 것
- 가상컬럼을 포함하고 있거나, JOIN을 사용한 SELECT문을 사용한다
...
-----------------------------------------------------------------------------------------------
203	송은희	631010-2653546	song_eh@BS.or.kr	01077607879	D6	J4	S5	2800000		204	96/05/03		N	여
206	박나라	630709-2054321	pack_nr@BS.or.kr	01096935222	D5	J7	S6	1800000		207	08/04/02		N	여
207	하이유	690402-2040612	ha_iy@BS.or.kr	01036654488	D5	J5	S5	2200000	0.1	200	94/07/07		N	여
210	윤은해	650505-2356985	youn_eh@BS.or.kr	0179964233	D5	J7	S5	2000000		207	01/02/03		N	여
212	장쯔위	780923-2234542	jang_zw@BS.or.kr	01066682224	D8	J6	S5	2550000	0.25	211	15/06/17		N	여
217	전지연	770808-2665412	jun_jy@BS.or.kr	01033624442	D1	J6	S4	3660000	0.3	214	07/03/20		N	여
218	이오리	870427-2232123	loo_or@BS.or.kr	01022306545		J7	S5	2890000			16/11/28		N	여
222	이태림	760918-2854697	lee_tr@BS.or.kr	01033000002	D8	J6	S5	2436240	0.35	100	97/09/12	17/09/12	Y	여
```
- FROM 안에 서브쿼리를 이용해서 가상컬럼(컬럼)처럼이용한다.
- 그래서 WHERE에 별칭을 넣어서 사용할수가있다.
...
------------------------------------------------------------
J2	201	송종기	631156-1548654	song_jk@BS.or.kr	01045686656	D9	S1	6000000		200	01/09/01		N	D9	총무부	L1	부사장
J2	202	노옹철	861015-1356452	no_hc@BS.or.kr	01066656263	D9	S4	3700000		201	01/01/01		N	D9	총무부	L1	부사장
```
- FROM 안에 가상컬럼을 만들어서
- 가상컬럼이 가지고 있는
- 컬럼들을 WHERE을 사용할수가있다.
...
# 56. ROWNUM
- ROWNUM 은 SELECT해온 데이터에 일련번호를 붙이는것이다.
- 모든 데이터를 검색하지않고 특정 개수만큼 원하는 데이터를 추출하고싶을때 사용한다.
...
```
- 여기서 주의할점이있다
- OREDR BY 를 FROM절에 같이써줘야한다.
- 안그러면 정렬을하기전에 일련번호를 붙이고 정렬하기떄문이다.
- ORDER BY는 마지막에 실행되기떄문이다.
- **ROWNUM은 SELECT문이 실행될때 부여가된다!**


<BR/>

## 5~10까지 구하기
- ROWNUM 을이용하면 중간범위있는녀석을 찾지못한다.
- 그래서 이걸 컬럼으로 만들어서 사용한다
- 테이블취급을 하는거다.
