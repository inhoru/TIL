# 🔖 목차
1. [File클래스 생성하기](#1-File클래스-생성하기)<br/>
2. [지정된 파일 생성하기](#2-지정된파일-생성하기)<br/>
3. [내가 원하는 폴더에 생성하기](#3-내가-원하는-폴더에-생성하기)<br/>
4. [file 삭제하기](#4-file-삭제하기)<br/>
5. [파일에대한 정보 확인하기](#5-파일에대한-정보-확인하기)<br/>
6. [전체파일 가져오기](#6-전체파일-가져오기)<br/>
